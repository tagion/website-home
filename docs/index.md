...
<div class="center">Tagion is a global, open-source platform for decentralized applications. On Tagion, you can write code that controls digital value, runs exactly as programmed, and is accessible anywhere in the world.</div>
...
<div class="intro-block">
  ...
  <ul>
    ...
    <li class="highlight">Completely new to Tagion?</li>
    <li>What is Tagion?</li>
  ...
  <ul>
    ...
    <li><router-link to="/use/#_1-use-an-application-built-on-ethereum" class="black">What can I do with Tagion today?</router-link></li>
  ...
  <div class="intro-block">
    <ul>
      ...
      <li><router-link to="/learn/#how-ethereum-works" class="black">How Tagion works</router-link></li>
